...
const baselineHeight = y < 750 ? 680 : 800
...
const BaseStyle = {
    ...
    UNIT: em(1),
    calculateHeight: (payload) => (y / 100) * payload,
    calculateWidth: (payload) => (x / 100) * payload,
    scale: (value) => Math.round((y / baselineHeight) * value),
}
